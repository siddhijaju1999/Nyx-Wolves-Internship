...
if ($conn==false) {
	...
	$no_s=$_SESSION['no_s'];
    $ad=$_SESSION['sort'];
    $sql="select * from flights where source1='$Source' AND destination='$Destination' Order By Price $ad ";
...
<center><input type="submit" value="Book" name="submit">

<a href="traveller.html">Go Back</a></center>
